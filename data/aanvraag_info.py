...
class FileType(Enum):
    ...
    def __str__(self):
        STR_DICT = {FileType.UNKNOWN: '?', FileType.AANVRAAG_PDF: 'PDF-file (aanvraag)',  
                    FileType.OORDEEL_DOCX: 'Formulier beoordeling (Word format)', FileType.GRADED_DOCX: 'Ingevuld formulier beoordeling (Word format)', FileType.GRADED_PDF: 'Ingevuld formulier beoordeling (PDF format)', 
